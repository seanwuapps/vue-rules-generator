  ...
  vueProject: {
    ...
    rules: {
      ...
      componentNaming: {
        ...
        ruleGenerate: (value: boolean | string) => `Component names should be in ${value}`,
      },
      useComposables: {
        label: 'Use Composables for Reusable Logic',
        value: true,
        control: 'toggle',
        ruleGenerate: (value: boolean | string) => value ? 'Use composables for reusable logic' : '',
      },
    },
  },
  linting: {
    ...
    rules: {
      semicolons: {
        ...
        value: true,
        control: 'toggle',
        ruleGenerate: (value: boolean | string) => value ? 'Use semicolons at the end of statements' : 'Do not use semicolons at the end of statements',
      },
      quotes: {
        label: 'Quote Style',
        value: 'single',
        ...
        ruleGenerate: (value: boolean | string) => `Use ${value} quotes for strings`,
      },
    },
  },
  fileOrganization: {
    ...
    rules: {
      composablesDir: {
        ...
        value: true,
        control: 'toggle',
        ruleGenerate: (value: boolean | string) => value ? 'Keep composables in a dedicated `composables` directory' : '',
      },
      autoImports: {
        label: 'Enable Auto-Imports',
        value: true,
        control: 'toggle',
        ruleGenerate: (value: boolean | string) => value ? 'Enable auto-imports for components and composables' : '',
      },
    },
  },
});
